export function IntroText() {
  return (
    <div className="flex flex-col gap-4">
      <div className="text-2xl font-bold">Welcome to Umalator - Global</div>

      <div className="bg-blue-200 p-4 rounded-md">
        11/11 update: Duels have not yet been implemented - everything else
        should work as expected.
      </div>

      <div className="bg-amber-200 p-4 rounded-md">
        Warning: the enhancements made to this umalator fork enables usage of
        the tool as a more comprehensive race simulator, to simulate raw skill
        length differences without RNG factors{' '}
        <strong>set 'Position Keep' to 'Approximate'</strong> and{' '}
        <strong>turn off 'Wit Variance'</strong>
      </div>

      <div className="bg-amber-200 p-4 rounded-md">
        Raw skill length comparisons, as per the original umalator, have been
        battle-tested on JP and remain largely accurate. New additions such as
        Wit Variance and Virtual Pacemaker are experimental and results with
        these features should be taken with a grain of salt.
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-1">
          <div className="text-md font-bold">Transparent Dino</div>
          <p>
        ...
        <div>
          <div className="text-md font-bold">jechtoff2dudes</div>
          <p>
        ...
        <div>
          <div className="text-md font-bold">Kachi</div>
          <p>
      ...
      <div>
        ...
        the JP server for several years. Please use this if you KNOW what the
        hell you are doing.
      </div>
      ...
      <details>
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              YOU CAN NOW FORCE SKILLS ACTIVATIONS AT CERTAIN DISTANCES!!! LIKE
              PROFESSOR OF CURVATURE ON A STRAIGHT!
            </li>
            <li>
        ...
        <section>
          ...
          <ul>
            <li>
              <strong>
                Fix to use proper data for hills from the current global version
                instead of an approximation using data from a later patch
              </strong>{' '}
        ...
        <section>
          ...
          <ul>
            <li>
              Add caveats section describing the implementation of the simulator
            </li>
            <li>
              Allow selecting debuff skills multiple times to simulate multiple
              debuffers
            </li>
        ...
        <section>
          ...
          <ul>
            <li>
              Update Tokyo 2400m course to remove the hill at the start to match
              a game bug where skills do not activate on that hill or the hill
              does not exist
            </li>
          ...
          <ul>
            ...
            <li>
              <details>
                ...
                Primarily affects Swinging Maestro/Corner Recovery, Professor of
                Curvature/Corner Adept, and the strategy/distance corner skills
              </details>
            </li>
            <li>
            ...
            <li>
              <details>
                ...
                <ul>
                  ...
                  <li>
                    Double-click rows on the skill efficacy table to add them to
                    the simulated uma musume
                  </li>
                </ul>
              </details>
            </li>
      ...
      <footer>
        <div>Original Umalator Source code</div>
        <ul>
          <li>
            <a
