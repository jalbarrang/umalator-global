      ...
      {hasDebuffs && (
        <div
          className={cn(
            ...
            isTheoretical
              ? 'border border-dashed border-red-500/30'
      ...
      {hasHeals && hasDebuffs && (
        <div className="flex justify-between text-xs font-medium px-3">
          ...
          <span
            className={cn(
              'font-mono',
              netEffect >= 0 ? 'text-green-500' : 'text-red-500',
            )}
          >
            {netEffect >= 0 ? '+' : ''}
