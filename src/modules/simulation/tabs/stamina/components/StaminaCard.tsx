import { parseStrategy } from '@simulation/lib/runner/utils';
...
import { HpStrategyCoefficient } from '@/modules/simulation/lib/physics/health/policies/EnhancedHealthPolicy';
