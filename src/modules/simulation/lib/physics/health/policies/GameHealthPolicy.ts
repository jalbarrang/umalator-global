import { HpConsumptionGroundModifier, HpStrategyCoefficient } from '../HealthPolicy';
import { Strategy } from '../../../runner/types';
import { PositionKeepState } from '../../../skills/types';
import { CourseHelpers } from '../../../course/CourseData';
import type { IPositionKeepState } from '../../../skills/types';
import type { IStrategy, RunnerParameters } from '../../../runner/types';
import type { CourseData, IGroundCondition, IPhase, RaceState } from '../../../core/types';
