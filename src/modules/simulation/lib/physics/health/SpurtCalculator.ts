...
export function calculateSpurtDistance(
  ...
  const hpForBase = calculateRequiredHp(
    baseSpeed,
    distanceAtBase,
    baseSpeedCourse,
    groundCoef,
  ...
  const consumptionAtTarget = calculateHpPerSecond(
    targetSpeed,
    baseSpeedCourse,
    groundCoef,
    gutsModifier,
...
export function calculateRequiredHpInPhase2(
  ...
  const hpPhase2 = calculateRequiredHp(
    phase2Speed,
    phase2Length,
    baseSpeedCourse,
    groundCoef,
...
export const calculateBaseMidRaceTargetSpeed = (options: {
  ...
  const { runnerSpeed, baseSpeed, strategySpeedCoefficient, distanceProficiencyModifier } = options;
