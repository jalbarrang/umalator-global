...
export const SkillPerspectiveName = {
...
export const SkillTargetName = {
  ...
  [SkillTarget.KakariAhead]: 'Rushed Ahead',
  [SkillTarget.KakariBehind]: 'Rushed Behind',
  [SkillTarget.KakariStrategy]: 'Rushed Strategy',
...
export const PositionKeepStateName = {
