 ...
 *
 * TS-engine adaptive optimization oracle (mirrors the live
 * `skill-planner/optimization-engine-wasm.ts`). See this directory's README and
 * ADR-0004. Production planner optimization runs on WASM.
 */
import { runSkillCombinationComparison } from './skill-combination.reference';
import { calculateCombinationCost, generateCombinations } from '@/modules/skill-planner/optimizer';
import type {
  CandidateSkill,
  CombinationResult,
