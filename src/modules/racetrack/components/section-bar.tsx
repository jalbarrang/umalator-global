 ...
 */
export const SectionBar = React.memo<SectionBarProps>(
      ...
      const straightBoxes = straights.map((s, i) => (
        ...
        >
          ...
          <rect
            ...
            height="10%"
            width="100%"
            fill={STRAIGHT_COLORS.accent[i % 2]}
          />
