...
import { NodeType } from './ConditionParser';
import { AndOperator, OrOperator } from './ActivationConditions';
import type { Node } from './ConditionParser';
import type { CmpOperator, Condition, Operator } from './ActivationConditions';
...
function andMatcher(conds: Array<CmpOperator>, node: Operator) {
